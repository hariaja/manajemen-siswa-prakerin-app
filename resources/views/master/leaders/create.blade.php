        ...
        <div class="row justify-content-center">
          <div class="col-md-6">
            ...
            <div class="mb-4">
              ...
              <input type="email" name="email" id="email" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror" placeholder="{{ trans('Input Email Dosen') }}">
              @error('email')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="mb-4">
              ...
              <input type="text" name="nidn" id="nidn" value="{{ old('nidn') }}" class="form-control @error('nidn') is-invalid @enderror" placeholder="{{ trans('Input Nomor Induk Dosen Nasional') }}" onkeypress="return hanyaAngka(event)">
              @error('nidn')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
