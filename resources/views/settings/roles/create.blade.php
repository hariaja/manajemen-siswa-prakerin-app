  ...
  <div class="block block-rounded">
    <div class="block-header block-header-default">
      ...
      <div class="block-options">
        <a href="{{ route('roles.index') }}" class="btn btn-block-option">
          <i class="fa fa-chevron-left fa-xs me-1"></i>
          {{ trans('page.back') }}
        </a>
      </div>
    </div>
        ...
        <div class="row justify-content-center">
          <div class="col-md-6">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="{{ trans('Nama Peran Pengguna') }}" onkeypress="return hanyaHuruf(event)">
              @error('name')
