...
@section('content')
  <div class="block block-rounded">
    ...
    <div class="block-content">
        ...
        <div class="col-md-4">
          <div class="mb-4">
            ...
            <select type="text" class="form-select" name="status" id="status">
              ...
              <option value="{{ Constant::NEGERI }}">{{ Constant::NEGERI }}</option>
              <option value="{{ Constant::SWASTA }}">{{ Constant::SWASTA }}</option>
            </select>
          </div>
        </div>
      </div>
      ...
      @can('schools.create')
        <div class="mb-4">
          <a href="{{ route('schools.create') }}" class="btn btn-primary"><i class="fa fa-plus fa-xs me-2"></i>{{ trans('page.schools.create') }}</a>
        </div>
      @endcan
