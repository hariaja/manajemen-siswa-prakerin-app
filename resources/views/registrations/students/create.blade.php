      ...
      <div class="row justify-content-center">
        <div class="col-md-6">
          ...
          <div class="mb-4">
            ...
            <input type="text" name="major" id="major" value="{{ old('major') }}" class="form-control @error('major') is-invalid @enderror" placeholder="{{ trans('Etc. Teknik Komputer Jaringan') }}" onkeypress="return hanyaHuruf(event)">
            @error('major')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
