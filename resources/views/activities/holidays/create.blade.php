      ...
      <div class="row justify-content-center">
        <div class="col-md-6">
          ...
          <div class="mb-4">
            ...
            <input type="text" name="title" id="title" value="{{ old('title') }}" class="form-control @error('title') is-invalid @enderror" placeholder="{{ trans('Input Agenda Kegiatan') }}" onkeypress="return hanyaHuruf(event)">
            @error('title')
          ...
          <div class="mb-4">
            ...
            <input type="date" name="holiday_date" id="holiday_date" value="{{ old('holiday_date') }}" class="form-control @error('holiday_date') is-invalid @enderror">
            @error('holiday_date')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="mb-4">
            ...
            <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" cols="30" rows="10" placeholder="Input Deskripsi">{{ old('description') }}</textarea>
            @error('description')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
